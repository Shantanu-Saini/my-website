    ...
    <div id='projects' className="flex flex-col items-center md:px-20 px-5 py-20 h-max" style={{ backgroundColor: "#FAF9F6" }}>
      ...
      <div className='grid md:grid-cols-3 grid-cols-1 gap-x-8 gap-y-6 w-full'>
        <div className="flex flex-col justify-between items-center shadow-xl" style={{ backgroundColor: "#faf9f6", color: "#333333" }}>
          <img src={todo} alt="Feature Image" className="bg-slate-500 h-80 w-full rounded-t" />
          <div className='m-6'>
            ...
            <span className='flex justify-around'>
              <a href="https://task-todo-now.netlify.app/" target='_blank'><IoIosLink className='text-2xl'/></a>
              <a href="https://github.com/Shantanu-Saini/todo-app" target='_blank'><LuGithub className='text-2xl'/></a>
            </span>
          </div>
        </div>
        <div className="flex flex-col justify-between items-center shadow-xl" style={{ backgroundColor: "#faf9f6", color: "#333333" }}>
          <img src={learnLite} alt="Feature Image" className="bg-slate-500 h-80 w-full rounded-t" />
          <div className='m-6'>
            ...
            <hr className='my-3' />
            <span className='flex justify-around'>
              <a href="https://learn-lite.netlify.app/" target='_blank'><IoIosLink className='text-2xl'/></a>
              <a href="https://github.com/Shantanu-Saini" target='_blank'><LuGithub className='text-2xl'/></a>
            </span>
          </div>
        </div>
        <div className="flex flex-col justify-between items-center shadow-xl" style={{ backgroundColor: "#faf9f6", color: "#333333" }}>
          <img src={textOpr} alt="Feature Image" className="bg-slate-500 h-80 w-full rounded-t" />
          <div className='m-6'>
            ...
            <hr className='my-3' />
            <span className='flex justify-around'>
              <a href="https://text-opr.netlify.app" target='_blank'><IoIosLink className='text-2xl'/></a>
              <a href="https://github.com/Shantanu-Saini/text-Operation" target='_blank'><LuGithub className='text-2xl'/></a>
            </span>
          </div>
        </div>
        <div className="flex flex-col justify-between items-center shadow-xl" style={{ backgroundColor: "#faf9f6", color: "#333333" }}>
          <img src={keyLog} alt="Feature Image" className="bg-slate-500 h-80 w-full rounded-t" />
          <div className='m-6'>
            ...
            <hr className='my-3' />
            <span className='flex justify-around'>
              <a href="https://keypress-logger.netlify.app/" target='_blank'><IoIosLink className='text-2xl'/></a>
              <a href="https://github.com/Shantanu-Saini/key-logger" target='_blank'><LuGithub className='text-2xl'/></a>
            </span>
          </div>
        </div>
      </div>
